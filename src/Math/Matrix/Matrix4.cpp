...
float Matrix4::Determinant() const
{
    return m[0][0] * Minor(0, 0).Determinant() - m[0][1] * Minor(0, 1).Determinant() +
        m[0][2] * Minor(0, 2).Determinant() - m[0][3] * Minor(0, 3).Determinant();
}
...
std::ostream &operator<<(std::ostream &os, const Matrix4 &mat4)
{
    os << "[ " << mat4.m[0][0] << "  " << mat4.m[0][1] << "  " << mat4.m[0][2] << "  "
       << mat4.m[0][3] << " ]\n";
    os << "[ " << mat4.m[1][0] << "  " << mat4.m[1][1] << "  " << mat4.m[1][2] << "  "
       << mat4.m[1][3] << " ]\n";
    os << "[ " << mat4.m[2][0] << "  " << mat4.m[2][1] << "  " << mat4.m[2][2] << "  "
       << mat4.m[2][3] << " ]\n";
    os << "[ " << mat4.m[3][0] << "  " << mat4.m[3][1] << "  " << mat4.m[3][2] << "  "
       << mat4.m[3][3] << " ]";
    return os;
}
} // namespace N::M
